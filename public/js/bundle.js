...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY29sdG1hcCIsImEiOiJja3lxNnV1Mm8waDhjMzFtbXZ5ZjhpZWQ0In0.Rexn7w877QGJqI6mXujAOA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/coltmap/ckyq7qxw9istq16n2oof20ueb',
    scrollZoom: false // center: [-118.220181, 33.88581],
    // zoom: 5,
    // interactive: false,
...
var stripe = Stripe('pk_test_51KLjkeSCEbkOJRmlbVg1SACKVNEYWwMkgpQdAH2L7jLYYTJvFCcKncSU8aBdeMF9Ipqckzk99rJfgWn0hkHHn4t30054IasWtr');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); // prevents default action, in case of form 'submit'

    var form = new FormData();
    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]);
    (0, _updateSettings.updateSettings)(form, 'data'); // axios will recognise form an an object
  });
}
